<template>
  <div class="login-container">
    ...
    <div class="login-box">
      ...
      <form @submit.prevent="definirSenha" class="login-form">
        ...
        <button type="submit" class="login-button" :disabled="!novaSenha || !confirmarSenha || novaSenha !== confirmarSenha">
          <span class="button-text">Definir senha</span>
        </button>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    async definirSenha() {
      ...
      try {
        await api.put(`/usuarios/${this.userId}/criarSenha`, {
